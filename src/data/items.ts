...
export const ITEMS: readonly ItemDef[] = [
  ...
  { id: 'chalice', nm: 'Crimson Chalice', ico: I('crimson_chalice_icon.png'), sz: 2, cd: 4.4, eff: { dmg: 9 }, tags: ['Damage', 'Lifesteal'], heroId: 'vampire', life: 0.55, flav: 'Vintage: last Tuesday. Notes of regret.' },
  { id: 'bats', nm: 'Swarm of Bats', ico: I('swarm_of_bats_icon.png'), sz: 2, cd: 4.0, eff: { dmg: 3 }, hits: 3, tags: ['Damage', 'Lifesteal'], heroId: 'vampire', life: 0.55, flav: "They share everything. Especially what's yours." },
  ...
  { id: 'magmacore', nm: 'Magma Core', ico: I('magma_core_icon.png'), sz: 2, cd: 4.0, eff: { burn: 3 }, tags: ['Burn'], heroId: 'golem', flav: 'The heart of the mountain, sold by the pound.' },
  ...
  { id: 'furnaceheart', nm: 'Furnace Heart', ico: I('furnace_heat_icon.png'), sz: 3, cd: 6.0, eff: { dmg: 5, burn: 5 }, tags: ['Damage', 'Burn'], heroId: 'golem', flav: "Never goes out. Believe me, they've tried." },
